...
%INIT_COVE_AE Internal template-ablation override; do not use for paper runs.
...
if ~useStateInit
    ...
    useScenePriorTemplates = localTemplateFlag(params);
    if useScenePriorTemplates
...
function tf = localTemplateFlag(params)
tf = true;
if isstruct(params) && isfield(params, 'templateAblation') && ...
        isstruct(params.templateAblation) && ...
        isfield(params.templateAblation, 'useScenePriorTemplates')
    tf = logical(params.templateAblation.useScenePriorTemplates);
end
end
