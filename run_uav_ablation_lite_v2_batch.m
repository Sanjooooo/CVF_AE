...
row = table( ...
    ...
    localResultScalar(result, 'feedbackResponseCount'), ...
    localResultScalar(result, 'feedbackResponseSuccessCount'), ...
    elapsed, ...
    'VariableNames', {'Scene','Algorithm','Run','Seed','BestFitness','Runtime','Feasible','Violation','NEvals','FirstFeasibleIter','FirstFeasibleTime','RepairCount','RepairSuccessCount','FeedbackResponseCount','FeedbackResponseSuccessCount','WallClock'} );
end
