...
for s = 1:numel(sceneIds)
    ...
    for a = 1:numel(algorithms)
        ...
        row = table( ...
            ...
            mean(localColumnOrNan(sub, 'FeedbackResponseCount'), 'omitnan'), ...
            mean(localColumnOrNan(sub, 'FeedbackResponseSuccessCount'), 'omitnan'), ...
            ...
            mean(localColumnOrNan(sub, 'StateStaticFrac'), 'omitnan'), ...
            ...
            'MeanFeedbackResponseCount','MeanFeedbackResponseSuccessCount', ...
            'MeanStateFormationFrac','MeanStatePreservationFrac', ...
            'MeanStateRefinementFrac','MeanStateRecoveryFrac','MeanStateStaticFrac', ...
