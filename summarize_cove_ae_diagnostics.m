...
row = table( ...
    ...
    stateCounts.refinement, stateCounts.recovery, stateCounts.nUnique, ...
    stateCounts.formationFrac, stateCounts.preservationFrac, ...
    stateCounts.refinementFrac, stateCounts.recoveryFrac, ...
    ...
    'StateRecovery','StateUniqueCount', ...
    'StateFormationFrac','StatePreservationFrac','StateRefinementFrac', ...
    'StateRecoveryFrac','Operator1Count','Operator2Count','Operator3Count', ...
